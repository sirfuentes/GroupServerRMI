...
public class ObjectGroup {
    ...
    ObjectGroup(String aliasGrupo, int idGrupo, String aliasPropietario, String hostnamePropietaro) {
        this.auto_increment_id = 0;//
        this.alias = aliasGrupo;
        this.idg = idGrupo;
        this.propietario = new GroupMember(aliasPropietario, hostnamePropietaro, auto_increment_id, idGrupo);
    ...
    public GroupMember addMember(String aliasMiembro, String host) throws InterruptedException {
        lock.lock();
        ...
        if (add_remove) {
            ...
            GroupMember nuevoMiembro = new GroupMember(aliasMiembro, host, auto_increment_id, idg);
